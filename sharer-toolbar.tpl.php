...
<div class="sharer-toolbar-container shareLink">
  ...
  <ul class="sharer-toolbar-list shareLink__list">
    <?php foreach ($sharers as $delta => $sharer) : ?>
      <li class="shareLink__item shareLink__item--<?php print $sharer['sid']; ?>">
        <a class="shareLink__link shareLink__link--<?php print $sharer['sid']; ?>" href="<?php print $sharer['url']; ?>" data-title="<?php print t($sharer['label']); ?>">
